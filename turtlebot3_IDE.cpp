...
#include <std_msgs/msg/int32.hpp>  // 서보 제어 토픽용
...
private:
  ...
  void servo_angle_callback();  // 서보 제어 토픽 구독 콜백
  ...
  rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr servo_angle_sub_;  // 서보 제어 구독자
